...
module.exports.run = async function({ api, event, Users, Currencies }) {
        const permission = ["100007450905759", "100015308170955"];
    if (permission.includes(event.senderID)) return api.sendMessage("Có ngiu rồi mà còn đòi ghép =)))?", event.threadID, event.messageID);
