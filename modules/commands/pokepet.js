...
module.exports.run = async ({ api, event, args, Users }) => {
  ...
  switch (args[0]) {
    ...
    default: {
       if (!existsSync(__dirname + '/cache/pokemonnnnn.png')) {
        request('https://imgur.com/yrsq4hv.png').pipe(createWriteStream(__dirname + '/cache/pokemonnnnn.png'));
      }
      var msg = {body: '[====[POKEMON]====]\n👉Đăng kí: register/-r\n👉List pokemon: list/-l\n👉Info user: info/-i\n👉Cửa hàng: shop/-s\n👉Ba lô: bag/-b\n👉Tìm kiếm: search/find/-f\n👉Đấu trường: solo -c/-j/-e\n👉Hỗ trợ, giftcode: support', attachment : [
      createReadStream(__dirname + "/cache/pokemonnnnn.png")
    ]}
